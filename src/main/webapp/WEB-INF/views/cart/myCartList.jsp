...
body{
 background-image:url('https://goo.gl/1uZsu'); 
}
a{
color:#000000;
}
...
<body>
	<table class="list_view">
		<tbody align=center >
	       <tr style="background: linear-gradient(to bottom, #000000, #A4A4A4); color:#FFFFFF; text-align:center;" >
	       		<td></td>
                <td>구분</td>
				<td >상품명</td>
				<td>정가</td>
               ...
               <form name="frm_order_all_cart">
					...
					<td>
					   <input type="text" id="cart_goods_qty" name="cart_goods_qty" size=3 value="${cart_goods_qty}"><br>
						<a href="javascript:modify_cart_qty(${item.goods_id },${item.goods_price*0.9 },${cnt.count-1 });" >
						    <button type="button" style="text-align:center;" class="btn btn-outline-info btn-sm" id="change">변경</button>
						</a>
					</td>
					<td>
					   <strong>
					...
					<td>
					      <a href="javascript:fn_order_each_goods('${item.goods_id }','${item.goods_title }','${item.goods_sales_price}','${item.goods_fileName}');">
					       	<button type="button" style="width:87px; background-color:#848484; color:#FFFFFF; font-weight:bold; font-weight:300px;" class="btn btn-outline-secondary btn-sm" id="btns">주문하기</button></a> 
					       	
							</a><br>
					 	<a href="#"> 

					 	   <button type="button" style="width:87px; background-color:#f2f2f2; color:#585858; font-weight:bold; font-weight:300px;" class="btn btn-outline-secondary btn-sm" id="btns">나중에 주문</button></a> 
						</a><br> 
						<a href="#"> 
						   <button type="button" style="width:87px; background-color:#f2f2f2; color:#585858; font-weight:bold; font-weight:300px;" class="btn btn-outline-secondary btn-sm" id="btns">리스트 넣기</button></a> 
						</A><br> 
						<a href="javascript:delete_cart_goods('${item.goods_id}');"> 
						   <button type="button" style="width:87px; background-color:#f2f2f2; color:#585858; font-weight:bold; font-weight:300px;" class="btn btn-outline-secondary btn-sm" id="btns">삭제</button></a> 
					   </a>
					</td>
					   </div>
					   </div>
    ...
    <br><br>	
		 <a href="javascript:fn_order_all_cart_goods()">
		 	<button type="button" style="width:130px; background-color:#585858; color:#FFFFFF; font-weight:bold; font-weight:300px;" class="btn btn-outline-secondary btn-sm" id="btns">주문하기</button></a> 
		 </a>
		 <a href="#">
		 	<button type="button" style="width:130px; background-color:#585858; color:#FFFFFF; font-weight:bold; font-weight:300px;" class="btn btn-outline-secondary btn-sm" id="btns">쇼핑 계속하기</button></a> 
		 </a>
	<center>
