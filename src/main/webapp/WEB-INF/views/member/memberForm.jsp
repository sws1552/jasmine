...
<body>
	...
	<div id="detail_table">
			...
			<tbody>
				...
				<tr class="dot_line">
					<td class="fixed_join">이름</td>
							<td><input name="member_name" type="text" size="20" value="${userInfo.nickname}"/></td>
				...
				<tr class="dot_line">
					...
					<input type="radio" name="member_gender" value="102" />
						여성<span style="padding-left:50px"></span>
				...
				<tr class="dot_line">
					...
					<select name="member_birth_y">
					 ...
					 <select name="member_birth_m" >
					   <c:forEach var="month" begin="1" end="12">
					       <c:choose>
					         <c:when test="${userInfo.birth_m eq month }">
					...
					<select name="member_birth_d">
					       ...
					       <c:choose>
					         <c:when test="${userInfo.birth_d eq day }">
				...
				<tr class="dot_line">
					...
					<td>
					<input size="10px"   type="text" name="email1" value="${userInfo.email1}"/> @ 
					<input  size="10px" type="text" name="email2" value = "${userInfo.email2}"/> 
		...
		<tr >
			<td >
				<input type="hidden" name="kakao_id" id="kakao_id" value="${userInfo.kakao_id}">
				<input type="hidden" name="age_range" id="kakao_id" value="${userInfo.age_range}">
