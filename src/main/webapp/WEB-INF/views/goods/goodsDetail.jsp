...
<script type="text/javascript">
	function add_cart(goods_id) {
		$.ajax({
			...
			data : {
				goods_id:goods_id // ${contextPath}/cart/addGoodsInCart.do 여기에 goods_id :: key,value로 가지고 들어가서 로직 돌겠지?
								  // 그리고 그 이후에 리턴 된 값 data 객체로 받아서 밑에서 쓰는거겟지?
...
<body>
	...
	<div id="detail_table">
		...
		<ul class="mart">
			<li><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_id }','${goods.goods_title }','${goods.goods_sales_price}','${goods.goods_fileName}');" style="padding-top:0px">구매하기 </a></li>
			<li><a class="cart" href="javascript:add_cart('${goods.goods_id }')"style="padding-top:0px">
			장바구니</a></li>
			
			<li><a class="wish" href="#" style="padding-top:0px">위시리스트</a></li>
		</ul>
	</div>
	<div class="clear"></div>
	<!-- 내용 들어 가는 곳 -->
		...
		<div class="tab_container">
			<div class="tab_content" id="tab1">
				...
				<c:forEach var="image" items="${imageList }">
					<img src="${contextPath}/download.do?goods_id=${goods.goods_id}&fileName=${image.fileName}" width="100%">
				</c:forEach>
			</div>
	...
	<div id="layer" style="visibility: hidden">
		...
		<table>
			<tr>
			<th class="cart_get" style="background:#F2F2F2"> 상품 담기</th>
			</tr>
			...
			</a> <br /> <font  id="contents"><strong>상품이 카트에 담겼습니다.</strong></font><br>
						<br><font  id="contents2">바로 확인하시겠습니까?</font><br>
	<form   action='${contextPath}/cart/myCartList.do'  >				
			<br>
			<br>
			<button type="submit" class="btn btn-outline-info" id="yes1">예</button></a>
			<a href="javascript:" onClick="javascript:imagePopup('close', '.layer01');"> 
			<button type="button" class="btn btn-outline-dark" id="no1">아니오</button></a>
	</form>	 
		</td>	
		</tr>
	</table>
