...
<body>
			...
			<tr>
					...
					<td class="goods_description">
					   ...
					   <c:set var="arr" value="${fn:split(goods_pub_date,' ')}" />
						<div class="writer_press"  style="color:#000000;">${item.goods_writer }저
					...
					<td class="buy_btns">
						<a href="#" > 
					 	   <button type="button"  class="btn btn-outline-dark " id="btn_btn" >장바구니</button></a> 
						</a><br> 
						<a href="#" > 
						   <button type="button"  class="btn btn-outline-dark " id="btn_btn">구매하기</button></a> 
						</a><br> 
						<a href="#"> 
						   <button type="button"  class="btn btn-outline-dark " id="btn_btn">비교하기</button></a> 
						</a><br> 
					</td>
			</tr>
			</c:forEach>
	...
	<div id="page_wrap">
		<ul id="page_control">
			<li><a class="no_border" href="#"></a></li>
