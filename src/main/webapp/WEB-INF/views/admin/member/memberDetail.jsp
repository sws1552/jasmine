...
function fn_delete_member(member_id ,del_yn){
    ...
    frm_mod_member.action="/jasmine/admin/member/deleteMember.do";
...
<body>
	<h3 >내 상세 정보</h3>
<form name="frm_mod_member" class="frm_mod_member">	
	<div id="detail_table">
		<table class="table_detail">
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
					  <input type="button" style="background:#424242; font-color:#FFFFFF;" value="수정하기" onClick="fn_modify_member_info('${member_info.member_id }','address')" />
					</td>
				</tr>
			</tbody>
		</table>
