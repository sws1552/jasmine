...
function goodsDetail(){
	var cur_goods_num=document.getElementById("c오후 2:57 2020-08-09ur_goods_num");
...
<body>    
	...
	<div class="recent">
	 ...
	 <c:choose>
	    <c:when test="${ empty quickGoodsList }">
		    <p style="color:white; font-size:0.9em;">&nbsp; &nbsp; &nbsp;   0/0  &nbsp; </p>
	    </c:when>
	    <c:otherwise>
           <p style="color:white; font-size:0.9em;"><a  href='javascript:fn_show_previous_goods();' style="color:white;">&nbsp; 이전 </a><span id="cur_goods_num" style="color:white;">1</span>/${quickGoodsListNum}<a style="color:white;" href='javascript:fn_show_next_goods();'> 다음 </a> </p>
       </c:otherwise>
       </c:choose>
    </div>
</div>
